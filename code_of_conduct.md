...
> Is there an emergency? go straight to [REPORT AN ISSUE](#5.-reporting-issues). 
...
Bonfire is part of a broader movement for free culture and collective liberation in computing who believe that free software, open knowledge, and the digital commons belong to everyone, not just those who have historically dominated these spaces. We strive to embody in how we organise and relate to each other the kind of society we want to build, and to ensure that the tools and structures we create don't reproduce the very harms we set out to address. These harms are rooted in an extractive economy built on colonialism, imperialism, and patriarchy, on the exploitation of land and labour, and the concentration of wealth and power in the hands of the few.
...
We believe in community sovereignty and self-determination: the right of people, circles, and communities to govern themselves, define their own futures, and make decisions about their own spaces, rather than having those decisions made for them. Self-governance is not merely a preference but an act of resistance — a demonstration that our collective ability to care for each other and meet our own needs is more just and effective than the governance imposed by state or corporate forces.

We embrace principled boldness: building alternatives sometimes means acting without waiting for permission from systems that were never designed with our wellbeing in mind, and we support each other in taking courageous action that aligns with our shared values. We affirm the legitimate right of peoples and communities to resist oppression, assimilation, and exploitation — online and offline. Our tools and spaces exist to support that resistance, and we won’t moderate it into polite silence.

This means being involved as equal partners from the start — in identifying needs, planning, building, and evaluating — not just consulted after the fact. Across our overlapping communities and spaces, we support each other’s emotional and intellectual needs so that we can sustainably engage in discussion and collaborative work.
...
At the root of our community is dignity — not merely as a standard for how we treat each other, but as the force that compels us to say *enough* when we see injustice and no one is saying anything or doing anything. Dignity is what moves us to organise, to build, and to refuse.
...
- We welcome people of [all backgrounds and identities](#protected-characteristics) and actively work to make participation accessible, not just theoretically possible. We meet people where they are, not where we think they should be. Real inclusion sometimes means slowing down, and that's a trade-off worth making.

- **We're friendly and patient**, treating each other with empathy and gratitude.

- **We practice mutual aid and solidarity, not charity.** We share our time and abilities freely and without expectation of reciprocity, supporting each other as equals rather than as benefactors — building lasting networks of care and collective infrastructure, not performing acts of benevolence. One's idea of caring may differ from how others want to be cared for, so we **treat others the way _they_ want to be treated**, asking what's needed rather than assuming, as there are many ways to contribute and unexpected help isn't always welcome.
...
When we engage with other communities, we recognise that those most affected by a problem are those who best understand it, and we follow their leadership rather than arriving with assumptions about what's missing. We guard against saviorism and paternalism — the tendency to position ourselves as rescuers or to assume we know what others need better than they do.

We acknowledge the time and effort that goes into community work, much of it voluntary and often invisible (moderation, coordination, emotional support, documentation, translation, maintenance, etc) and recognise all of these contributions as equally valuable, approaching them with gratitude rather than entitlement.

- When we engage with other movements and communities, **we do not arrive to lead, to recruit, or to replicate ourselves.** We do not tell others what to do or ask them to be like us. We walk alongside — sharing our struggles, learning from theirs, seeking the points where our paths converge. Solidarity means accompanying, not directing.

- **Solidarity is not only a political commitment but something felt.** When we genuinely connect with others' struggles, we also touch their sorrows, and in them we recognise our own. True solidarity begins when we see ourselves reflected in each other.

- We respect each other's **privacy**. Sharing personal information without consent can put people at risk. We also avoid prying into personal details, such as someone's health, background, or identity, unless they're open to discussing them.

* We take into account each other's needs as individuals, and as a community.

- We foster **inclusive dialogue** by _sharing_ ideas, _asking_ clarifying questions, and _responding_ to others' ideas. We avoid excluding people through unnecessary jargon, gatekeeping knowledge, or dominating discussions with assumed authority.
...
- We are **mindful of how attention and visibility can create informal hierarchies.** We resist centring individuals as spokespeople or celebrities, and instead lift up collective work. When someone receives disproportionate attention, we check that it doesn't come at the cost of others' contributions being erased or undervalued.

- We acknowledge that **communities striving to make social progress — including our own — are not exempt from reproducing the very harms they set out to challenge.** The history of liberation movements shows that this must be named and organised against explicitly, not assumed away by good intentions. We commit to ensuring that women and other marginalised groups can participate, lead, and feel safe — not as a concession, but as a condition of the world we claim to be building.
> This means actively dismantling male-centeredness in our spaces: examining who speaks most, whose concerns are treated as urgent, whose expertise is assumed, and whose contributions go unrecognised — and reorganising when we find the patterns we expected to find.
...
>
> Don’t forget that it is human to err and blaming each other doesn’t get us anywhere. Instead, focus on helping to resolve issues and learning from mistakes. Some differences will be irreconcilable in a diverse community, and that’s okay — what matters is how we hold disagreement, not that we eliminate it.
...
- **We talk to and with people, not about them.** Before taking a concern to social media, group chats, or third parties, we try to address it directly with the person involved. Indirect remarks, subtoots, and vague-posting can be just as corrosive as direct confrontation, and bypass the possibility of repair. When direct communication isn’t safe or possible, we turn to moderators rather than the court of public opinion.
...
At the same time, this work should also enliven us — when we organise and build together in alignment with our values, it can be deeply satisfying and connective. Sustainable participation comes not just from rest, but from engagement that feels meaningful and alive.

Sustainability is also a strategic commitment: we build projects and practices designed to endure, with care for ourselves, each other, and the ecosystems we depend on treated as integral to the strength of the work, not separate from it.

> Community dialogues can often be challenging and triggering. We may be discussing issues that have caused great trauma in the world, and often, great trauma in our own lives. Some dialogues may bring up painful memories, old wounds, present hurts and current resentments.
>
> Facilitating such dialogue depends on our wellness. We prioritise SELF-CARE as a tool of radical self-love! We do what we need to do to navigate our mental, emotional and physical well-being, such as stopping conversations to focus on ourselves and come back when we are re-centred.
>
...
- We are **builders first.** We make *another world is possible* real through actions, not just words — constructing alternatives in how we organise, govern, and care for each other. Critique serves construction, not the other way around.

- Our **shared infrastructure** — code, documentation, and collective knowledge — **is a commons that belongs to the community**, not to any individual who administers or maintains it. We contribute to serve the community, not ourselves — the commons we build together is the reward, not personal advancement, recognition, or influence. It cannot be privatised, enclosed, or extracted for personal gain. Decisions about shared infrastructure should be made collectively and transparently, and access to it should not be leveraged as a source of personal power.

- We actively support **cooperative and participatory models** of organising — and oppose monopoly in all its forms, whether over platforms, protocols, development capacity, or community attention. Where individual or private initiative exists within our ecosystem, it must not concentrate power or undermine the communal economy we are building together.

- We affirm the **right of workers — including digital, creative, care, and platform workers — to organise**, to set the terms of their own labour, and to refuse exploitation. Our commitment to cooperative and commons-based models is inseparable from the struggle for workers' self-determination. We do not cross digital picket lines, and we stand with those who withhold their labour in pursuit of justice.
...
> This logic drives the [enshittification](https://en.wikipedia.org/wiki/Enshittification) of platforms: the cycle by which services that once served their users are degraded in pursuit of profit — first exploiting users' attention, then their data, then their communities. Our tools and spaces are not products to be marketed, and our communities are not audiences to be monetised. We build for use and for each other, not for extraction or exchange.

- We recognise that **surveillance — whether by states, corporations, or platforms — is a tool of control** disproportionately wielded against Black, Indigenous, migrant, and other marginalised communities. We commit to building tools that resist surveillance rather than enable it, and refuse to design features, collect data, or structure systems that could be used to monitor, profile, track, or police communities.

> Technology that cannot be turned against its users is not a limitation but a design principle.

- We **propose rather than impose.** We share our perspectives, ideas, and visions freely — inviting dialogue rather than demanding agreement. No person or group has the right to impose their beliefs, politics, or cultural norms on others through pressure or coercion. We respect that others' convictions are their own.

* We have space to **make mistakes, take responsibility, learn and change**. Blame is not useful, but accountability is: we don't blame ourselves or others for what we've absorbed from unjust systems, but once we know better, we're accountable for doing better. Those of us with more power or privilege carry a greater share of the responsibility for change.
...
* Offensive or unwelcome comments related to one's [background or identity](#protected-characteristics), including micro-aggressions (small, often unconscious actions or remarks that marginalise people).

* Minimising, dismissing, or treating the rights, identities, or lived experiences of marginalised people as topics for debate.

* Name calling, insensitive sarcasm, offensive jokes, and general unkindness. "It was just a joke" is not a defence.
...
* Intentionally spreading misinformation or disinformation that undermines safety, equity or consent. That includes posting or disseminating libel, slander, or other deliberately false claims.
...
* Continued one-on-one communication after requests to cease, or not disengaging from a conversation that is clearly escalating.
...
* Deliberate misgendering or mislabelling. This includes deadnaming or persistently using a pronoun that does not correctly reflect a person’s gender identity. We address people by their pronouns when provided, and otherwise default to their name/handle rather than guessing.
...
* Questioning or challenging someone’s stated self-identity or chosen labels, even if well-intentioned.
...
* Non-consensual pornography and sexualized images of people who did not consent to their likeness being shared.

* Promoting pedophilia or content involving the exploitation of minors in any form.

* Condoning, defending, enabling, or standing silently by during harassment or behaviour that violates these guidelines. This is not about guilt by association, but about complicity.
...
While harassment cannot be tolerated, there's a whole range of problematic behaviours or ways people communicate that are _not_ harassment, and we are empowered to politely engage when we or others are mistreated, by describing our perceptions.
...
We stand with those who take to the streets, who strike, who occupy, who blockade — and we oppose the criminalisation of protest and the use of state violence against those who resist. Our tools should support the right to organise and demonstrate, not enable the forces that suppress it.
...
* Confront the individuals involved. Participants asked to stop any harassing behavior are expected to stop immediately, even if they disagree with the assessment.
...
* A person's history of behaviour may be taken into account when deciding on consequences, while recognising that people have the right to transformation and should not be permanently defined by their worst moments or by the punishments imposed on them by unjust systems.
...
Bonfire is not a single community but an ecosystem of interconnected circles – some closely aligned, others more loosely connected – held together by a shared commitment to support each other's emotional and intellectual needs so that we can sustainably engage in discussion and collaborative work, and foster respect, diversity, inclusion, wellbeing and learning.

Our struggles are intimately connected. We resist single-issue framing that isolates concerns into silos, and instead recognise that housing, health, migration, gender violence, digital rights, and ecological crisis are expressions of the same underlying systems. When crisis or conflict disrupts our spaces, we recognise that the broken can make way for the new — that moments of rupture, however painful, can open possibilities for deeper solidarity and more just ways of organising. Groups working on similar issues consciously act in solidarity, incorporating each other's goals and values into their own work rather than just lending support.

That's fundamentally different from a “public forum” or a “debate hall”. Our structures and practices are shaped by what works, not by what theory says they should look like. We prefer flexible, evolving approaches over rigid blueprints, and remain willing to adapt our ways of organising as circumstances and needs change.
...
- The Zapatistas (EZLN), particularly the [principles of Zapatismo](https://globalsocialtheory.org/topics/zapatismo/), the [Sixth Declaration of the Selva Lacandona](https://enlacezapatista.ezln.org.mx/sdsl-en/) (2005), and the [Women's Revolutionary Laws](https://schoolsforchiapas.org/advances/women-in-zapatismo/the-womens-revolutionary-laws/) (1994)
- Social Contract of the Democratic Autonomous Federation of Northern Syria ([2014](https://internationalistcommune.com/social-contract/) and [2023](https://rojavainformationcenter.org/2023/12/aanes-social-contract-2023-edition/))
...
- [Co-op Cloud's Code of Co-operation](https://docs.coopcloud.tech/federation/code-of-coop/), with inspiration from [LURK](https://lurk.org/about/) and others
- [Sutty's Code for sharing](https://sutty.nl/en/code-of-conduct/)
- [LGBTQ in Technology](https://lgbtq.technology/coc.html)
- [The Anti-Oppression Network](https://theantioppressionnetwork.com/resources/saferspacepolicy/)
- [Occupy London](https://occupylondon.org.uk/about/statements/safer-space-policy/)
- [Occupy Dame Street](https://occupydamestreet.org/safer-space-policy)
- Mutual Aid Disaster Relief's [guiding principles](https://mutualaiddisasterrelief.org/guiding-principles/), code of conduct, and facilitation guide
...
- [The Movement for Black Lives — Vision for Black Lives](https://m4bl.org/policy-platforms/) (2016, updated 2020)
- [Jemez Principles for Democratic Organizing](https://ejnet.org/ej/)
- [Food Not Bombs](https://foodnotbombs.net/)
- [Principles of Environmental Justice](https://www.ejnet.org/ej/principles.pdf)
- [Principles of Climate Justice](https://www.ejnet.org/ej/) ()
- [Youth Principles of Collaboration](https://www.ejnet.org/ej/) (Second National People of Color Environmental Leadership Summit)
- #WeGotOurBlock — Mutual Aid 101 Toolkit
- [Mutual Aid: Building Solidarity During This Crisis (and the Next)](https://theanarchistlibrary.org/library/dean-spade-mutual-aid) by Dean Spade (Verso, 2020)
- scott crow, [Anarchy and the Common Ground Collective](https://theanarchistlibrary.org/library/scott-crow-anarchy-and-the-common-ground-collective) (2006)
- [Red de Apoyo Mutuo de Puerto Rico](https://redapoyomutuo.com/english-1) 
- [Humans United in Mutual Aid Networks (HUMANs)](https://www.mutualaidnetwork.org/)
- [Gathering for Open Science Hardware (GOSH)](https://openhardware.science/gosh-2017/gosh-code-of-conduct/), with inspiration from The Carpentries, The Turing Way, Django, and others.
- [Queer code](https://queer-code.org/coc)
- [Fedora](https://docs.fedoraproject.org/en-US/project/code-of-conduct/)
- [Python](https://policies.python.org/python.org/code-of-conduct/) 
- [Elixir](https://github.com/elixir-lang/elixir/blob/main/CODE_OF_CONDUCT.md)

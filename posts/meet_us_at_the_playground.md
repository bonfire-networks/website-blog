...
As part of the sign-up process, all users will be asked to agree to a [Code of Conduct](/conduct/). The Bonfire team has spent time and effort in crafting this document, and expect it to be followed in all spaces operated by us. Of course, feedback on improving future versions of the code of conduct is welcome. Please follow the guildelines for [reporting issues](/conduct/#6.-reporting-issues) should you come across anything which contravenes the Code of Conduct.

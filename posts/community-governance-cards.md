...
One of the EGR 373 projects, “Community Governance Cards,” was led by ECE major Prishaa Kapasi (‘29), with support from MSE student Michelle Le (‘27). As part of our broader project CROW (“Community Rules for an Open Web,”) this project was based on research findings from design workshops with fediverse folks that the Princeton HCI lab ran last year, published at [CHI’26](https://dl.acm.org/doi/10.1145/3772318.3790855). A key idea in the workshops was inspired by tools like CC licenses or Model Cards: give communities a concise, structured way to document how they govern themselves, across core dimensions like infrastructure, membership, rules, and so on. Whereas this information is typically informal, scattered, or entirely undocumented, Governance Cards become a simple and consistent way of sharing norms and context.
